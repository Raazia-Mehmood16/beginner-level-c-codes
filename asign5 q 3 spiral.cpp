...
int main() {
    ...
    int matrix[m][n]; 
    int spiral[10000]; //  store  spiral order
    int rearranged[10000]; //  store  rearranged numbers
    int sInd = 0;
 ...
 rLeft++;
    ...
    //  Rearrange by even odd
    int eInd = 0, oInd = 0;
    
    // First even numbers rearranged array
    ...
    // Then, odd numbers rearranged array
